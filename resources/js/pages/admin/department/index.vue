...
export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: "Name Label", align: "start", sortable: true, value: "title", },
            { text: "No. of grade class", align: "start", sortable: false, value: "content", },
    ...
    methods: {
        async fetchPage() {
            ...
            axios.get(`/admi/announcement?${params}`).then(({ data }) => {
